...
// „Mitglied einladen" als eigene Unterseite (UI-Fix 3): Invite-Formular + die
// „Ausgestellte Invites"-Liste zusammen, hinter dem Admin-Hub-Button erreichbar.
// Logik (Einladen, Magic-Link kopierbar, Status-Chips) unverändert — nur verschoben.
export default function AdminEinladen() {
  const { user } = useAuth();
  ...
  return (
    <div className="bwza-stage" style={{ padding: '0 var(--bwza-page-x) 40px' }}>
      ...
      <div style={{ paddingTop: 30, paddingBottom: 18 }}>
        <div className="bwza-eyebrow">Verwaltung</div>
        <div
          style={{
